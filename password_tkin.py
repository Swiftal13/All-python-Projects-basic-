...
root.configure(bg = "#a8c3f0")    

#all letters and numbers
char = string.ascii_letters + string.digits

#label widgets and placement  
label_1 = Label(root, text = "Password generator", bg = "#a8c3f0",fg = "white", borderwidth=0, relief="ridge") 
label_1.pack(side = TOP)

stringvar_generating = StringVar()
label_generating = Label(root, textvariable = stringvar_generating, bg = "#a8c3f0")
label_generating.pack()

stringvar_password = StringVar()
label_password = Label(root, textvariable=stringvar_password, bg = "#a8c3f0")
...
def custom():
    ...
    label_custom_password = Label(root2, textvariable = stringvar_custompassword, bg = "#a8c3f0")
    def emilian():
        leans = int(entry.get())
